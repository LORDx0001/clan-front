        ...
        <AnimatePresence>
          {selectedPlayer && (
            <div 
              ...
              className="fixed inset-0 z-[150] bg-battle-dark/95 backdrop-blur-md overflow-y-auto scroll-smooth cursor-pointer touch-pan-y overscroll-contain"
            >
              <div className="flex items-start justify-center min-h-screen py-8 px-2 sm:px-4">
                <motion.div
                  ...
                  className="bg-battle-gray border-2 border-pubg-orange text-white w-full max-w-3xl rounded-lg overflow-hidden relative cursor-default my-auto touch-pan-y"
                >
